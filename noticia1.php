...
<body>
    ...
    ?>
        ...
        <div class="container">
            ...
            <article>
                <div class="col-md-12">
                <h1>Cloud computing: o que é o modelo de serviços IaaS?</h1>
                <img src="imagens/imgTecnologia/noticia1.jpg" class="GlobalImgResponsive GlobalImgN" alt="Imagem de um nuvem de informações tecnológicas">                      
                <p>
    ...
    <section>
        ...
        <a href="aplicativo2.php" target="_blank"><h3>Clique e confira</h3></a> 
        </div>
    ...
    <section>
        ...
        <a href="redes.php" target="_blank"><h3>Clique e confira</h3></a> 
        </div>
